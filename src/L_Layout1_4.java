...
public class L_Layout1_4 extends JPanel {
	...
	public L_Layout1_4(int number, String name, int asYear, int asMonth, int asDay, int adMonth, int adDay, int aDays, int year, int month, int day, String parentName, String teacher) {
		setLayout(null);
		...
		outsideTableBorder.setSize((int)(162.65f * Util.A4_WEIGHT), (int)(134.62f * Util.A4_WEIGHT));
		outsideTableBorder.setLocation((int)(Util.A4_WIDTH * Util.A4_WEIGHT / 2) - (int)(162.65f * Util.A4_WEIGHT / 2), 198);
		...
		insideTableNormalBorder1.setSize((int)(31.18f * Util.A4_WEIGHT), (int)(134.62f * Util.A4_WEIGHT));
		...
		insideTableDotBorder1.setSize((int)(162.65f * Util.A4_WEIGHT), (int)(12.24f * Util.A4_WEIGHT) + 1);
		...
		content1L.setLocation((int)(Util.A4_WIDTH * Util.A4_WEIGHT / 2) - 200, 100);
		...
		content3L.setSize((int)(31.18f * Util.A4_WEIGHT), (int)(12.24f * Util.A4_WEIGHT) + 2);
		...
		content4L.setSize((int)(31.18f * Util.A4_WEIGHT), (int)(12.24f * Util.A4_WEIGHT) + 1);
		...
		content5L.setSize((int)(31.18f * Util.A4_WEIGHT), (int)(110.14f * Util.A4_WEIGHT));
		content5L.setLocation(65, 265);
		content5L.setOpaque(true);
		content5L.setBackground(new Color(229, 229, 229));
		
		JLabel content6L = new JLabel(asYear + "년    " + asMonth + "월    " + asDay + "일  ~    " + adMonth + "월    " + adDay + "일 (총  " + aDays + " 일간)");
		content6L.setFont(new Font("함초롬바탕", Font.PLAIN, 12));
		content6L.setSize((int)(131.47f * Util.A4_WEIGHT) - 2, (int)(12.24f * Util.A4_WEIGHT) + 2);
		...
		JLabel content8L = new JLabel(year + "년     " + month + "월      " + day + "일", JLabel.CENTER);
		content8L.setFont(new Font("함초롬바탕", Font.PLAIN, 14));
		content8L.setSize(200, 20);
		content8L.setLocation((int)(Util.A4_WIDTH * Util.A4_WEIGHT / 2) - 100, 605);
		
		JLabel content9L = new JLabel("보호자(관계 :  모  )");
		content9L.setFont(new Font("함초롬바탕", Font.PLAIN, 14));
		content9L.setSize(160, 20);
		content9L.setLocation(263, 637);
		
		JLabel content10L = new JLabel(parentName + "         (인)", JLabel.RIGHT);
		content10L.setFont(new Font("함초롬바탕", Font.PLAIN, 14));
		content10L.setSize(220, 20);
		content10L.setLocation(298, 637);
		
		JLabel content11L = new JLabel("확인 : 담임교사");
		content11L.setFont(new Font("함초롬바탕", Font.PLAIN, 14));
		content11L.setSize(160, 20);
		content11L.setLocation(263, 659);
		
		JLabel content12L = new JLabel(teacher + "         (인)", JLabel.RIGHT);
		content12L.setFont(new Font("함초롬바탕", Font.PLAIN, 14));
		content12L.setSize(220, 20);
		content12L.setLocation(298, 659);
		
		JLabel content13L = new JLabel("화 명 고 등 학 교 장  귀 하");
		content13L.setFont(new Font("함초롬돋움", Font.BOLD, 24));
		content13L.setSize(300, 30);
		content13L.setLocation(60, 689);
		...
		add(content11L); add(content12L); add(content13L);
	}
