 ...
 */
public class S_RangeSliderUI extends BasicSliderUI {
     ...
     * @param b RangeSlider
     */
    public S_RangeSliderUI(S_RangeSlider b) {
        super(b);
    }
    ...
    public void scrollByBlock(int direction) {
        synchronized (slider) {
            ...
            if (upperThumbSelected) {
                int oldValue = ((S_RangeSlider) slider).getUpperValue();
                ((S_RangeSlider) slider).setUpperValue(oldValue + delta);
            } else {
