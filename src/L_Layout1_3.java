...
public class L_Layout1_3 extends JPanel {
	...
	public L_Layout1_3(int number, String name) {
		setLayout(null);
		...
		content1L.setLocation((int)(A4_WIDTH * A4_WEIGHT / 2) - 100, 120);
		...
		JLabel content10L = new JLabel("2019년       월        일", JLabel.CENTER);
		content10L.setFont(new Font("함초롬바탕", Font.PLAIN, 15));
		content10L.setSize(200, 20);
		content10L.setLocation((int)(A4_WIDTH * A4_WEIGHT / 2) - 100, 500);
		
		JLabel content11L = new JLabel("보호자                      (인)");
