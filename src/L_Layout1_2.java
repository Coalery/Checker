...
public class L_Layout1_2 extends JPanel {
	...
	public L_Layout1_2(int number, String name) {
		setLayout(null);
		...
		titleL.setLocation((int)(L_Layout1_1.A4_WIDTH * L_Layout1_1.A4_WEIGHT / 2) - 150, 78);
		
		JPanel outsideTableBorder = new JPanel();
		outsideTableBorder.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));
		outsideTableBorder.setSize((int)(162.97f * A4_WEIGHT), (int)(162.05f * A4_WEIGHT));
		outsideTableBorder.setLocation((int)(L_Layout1_1.A4_WIDTH * L_Layout1_1.A4_WEIGHT / 2) - (int)(162.97f * A4_WEIGHT / 2), 132);
		...
		insideTableNormalBorder1.setSize((int)(23.55f * A4_WEIGHT), (int)(162.05f * A4_WEIGHT));
		...
		insideTableNormalBorder2.setSize((int)(162.97f * A4_WEIGHT), (int)(38.84f * A4_WEIGHT));
		...
		insideTableNormalBorder3.setSize((int)(162.97f * A4_WEIGHT), (int)(28.59f * A4_WEIGHT));
		...
		insideTableDotBorder1.setSize((int)(162.97f * A4_WEIGHT), (int)(10.87f * A4_WEIGHT) + 1);
		...
		insideTableDotBorder2.setSize((int)(162.97f * A4_WEIGHT), (int)(16.86f * A4_WEIGHT) + 1);
		...
		insideTableDotBorder3.setSize((int)(139.42f * A4_WEIGHT) + 1, (int)(17.62f * A4_WEIGHT));
		...
		insideTableNormalBorder4.setSize((int)(27.89f * A4_WEIGHT), (int)(28.59f * A4_WEIGHT));
		...
		insideTableNormalBorder5.setSize((int)(27.89f * A4_WEIGHT), (int)(28.59f * A4_WEIGHT));
		...
		insideTableDotBorder4.setSize((int)(162.97f * A4_WEIGHT), (int)(17.9f * A4_WEIGHT));
		...
		content1L.setSize((int)(23.55f * A4_WEIGHT) - 2, (int)(10.87f * A4_WEIGHT) - 1);
		...
		content2L.setSize((int)(23.55f * A4_WEIGHT) - 2, (int)(16.86f * A4_WEIGHT) + 1);
		...
		content3L.setSize((int)(23.55f * A4_WEIGHT) - 2, (int)(11.11f * A4_WEIGHT) - 1);
		...
		content4L.setSize((int)(23.55f * A4_WEIGHT) - 2, (int)(28.59f * A4_WEIGHT) - 1);
		...
		content5L.setSize((int)(23.55f * A4_WEIGHT) - 2, (int)(17.9f * A4_WEIGHT) + 2);
		...
		content6L.setSize((int)(23.55f * A4_WEIGHT) - 2, (int)(76.72f * A4_WEIGHT) + 4);
		...
		content7L.setSize((int)(27.89f * A4_WEIGHT) - 2, (int)(17.62f * A4_WEIGHT) - 2);
		...
		content8L.setSize((int)(27.89f * A4_WEIGHT) - 2, (int)(17.62f * A4_WEIGHT) - 2);
		...
		content9L.setSize((int)(27.89f * A4_WEIGHT) - 2, (int)(17.62f * A4_WEIGHT) - 2);
		...
		content10L.setSize((int)(27.89f * A4_WEIGHT) - 2, (int)(17.62f * A4_WEIGHT) - 2);
		...
		content11L.setSize((int)(27.89f * A4_WEIGHT) - 2, (int)(17.62f * A4_WEIGHT) - 2);
		...
		content12L.setSize((int)(139.42f * A4_WEIGHT) - 2, (int)(10.87f * A4_WEIGHT) - 2);
		content12L.setLocation(145, 133);
		
		JLabel content13L = new JLabel("2019년      월      일  ~      월      일 (총     일간)");
		content13L.setFont(new Font("함초롬바탕", Font.PLAIN, 11));
		content13L.setSize((int)(139.42f * A4_WEIGHT) - 2, (int)(16.86f * A4_WEIGHT) - 2);
		content13L.setLocation(145, 162);
		
		JLabel content14L = new JLabel("2019년      월      일", JLabel.CENTER);
		content14L.setFont(new Font("함초롬바탕", Font.PLAIN, 14));
		content14L.setSize(150, 20);
		content14L.setLocation((int)(L_Layout1_1.A4_WIDTH * L_Layout1_1.A4_WEIGHT / 2) - 75, 590);
		...
		JLabel content16L = new JLabel("생 :                          인", JLabel.RIGHT);
		content16L.setFont(new Font("함초롬바탕", Font.PLAIN, 13));
		content16L.setSize(230, 20);
		content16L.setLocation(272, 625);
		
		JLabel content17L = new JLabel("학부모 :                          인", JLabel.RIGHT);
		content17L.setFont(new Font("함초롬바탕", Font.PLAIN, 13));
		content17L.setSize(230, 20);
		content17L.setLocation(272, 650);
		
		JLabel content18L = new JLabel("화 명 고 등 학 교 장  귀 하");
		content18L.setFont(new Font("함초롬돋움", Font.BOLD, 21));
		content18L.setSize(250, 30);
		content18L.setLocation(55, 687);
		...
		add(content16L); add(content17L); add(content18L);
	}
